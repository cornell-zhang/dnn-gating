...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option='A', **kwargs):
        ...
        #print("wbits:{}, abits:{}, trunc bits:{}".format(kwargs['wbits'], kwargs['abits'], kwargs['pred_bits']))
        self.conv1 = G.CGConv2d(in_planes, planes, kernel_size=3, 
                                stride=stride, padding=1, bias=False,
                                p=kwargs['partitions'], th=kwargs['ginit'], alpha=kwargs['alpha'],
                                use_group=kwargs['use_group'], shuffle=kwargs['shuffle'], sparse_bp=kwargs['sparse_bp'])
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = G.CGConv2d(planes, planes, kernel_size=3, 
